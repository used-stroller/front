...
export default function PrivacyPolicyPage(): JSX.Element {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-800 leading-relaxed">
      <h1 className="text-3xl font-bold mb-8 text-center">개인정보 처리방침</h1>

      <p className="mb-6">
        <strong>중모차(jungmocha.co.kr)</strong>은 「개인정보 보호법」에 따라
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-2">3. 보유 및 이용 기간</h2>
        <p className="mb-2">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-2">4. 제3자 제공 및 위탁</h2>
        <ul className="list-disc ml-5 space-y-1">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-2">5. 정보주체의 권리</h2>
        <p className="mb-2">
          이용자는 언제든지 개인정보 관련 아래 권리를 행사할 수 있습니다.
        </p>
        <ul className="list-disc ml-5 space-y-1">
        ...
        <p className="mt-2">
          ※ 고객센터:{" "}
          <a
            href="mailto:mattang123@naver.com"
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-2">6. 개인정보 보호 책임자</h2>
        <ul className="ml-5">
          <li>성명: 이동훈</li>
          <li>직책: 개인정보 보호책임자</li>
          <li>이메일: mattang123@naver.com</li>
          <li>전화: 010-8113-6030</li>
        </ul>
      </section>

      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-2">7. 쿠키 사용 안내</h2>
        <p className="mb-2">
          중모차는 사용자 경험 향상을 위해 쿠키를 사용합니다. 브라우저 설정을
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">8. 고지 의무</h2>
        <p>
